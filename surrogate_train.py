...
confs = (
  ...
  # {'gs': 4,  'enc': 'Phase+ISI', 'nb_steps': 100, 'lr': .0005, 'dataset': 'MNIST', 'seed': 1234, 'nb_hidden': 10},
    ...
    # -------
  # {'gs': 1,  'enc': 'ISI', 'nb_steps': 100, 'lr': .0005, 'dataset': 'FMNIST', 'seed': 1234, 'invertdata': False},
  # {'gs': 1,  'enc': 'ISI', 'nb_steps': 100, 'lr': .0005, 'dataset': 'FMNIST', 'seed': 1234, 'invertdata': True},
  # {'gs': 1,  'enc': 'TTFS', 'nb_steps': 100, 'lr': .0005, 'dataset': 'FMNIST', 'seed': 1234, 'invertdata': False},
  {'gs': 4,  'enc': 'Phase+TTFS', 'nb_steps': 100, 'lr': .0005, 'dataset': 'FMNIST', 'seed': 1234},
  {'gs': 4,  'enc': 'Phase+ISI', 'nb_steps': 100, 'lr': .0005, 'dataset': 'FMNIST', 'seed': 1234},
)
...
for c in confs:
    ...
    fpath = 'SSG_{}__{}__gs{}_i{}_h{}_tot{}__epochs{}_lr{}_div{}_nbs{}_ts{}__seed{}_tmx{}_misi{}_oisi{}{}{}'.format(
        c['dataset'], c['enc'].replace('+', ''), c['gs'], nb_inputs, nb_hidden, total_weights, epochs, 
